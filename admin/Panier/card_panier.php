<div class="product">
    <div class="image_product" style="background: url('../upload_images/<?= $row['image_produit'] ?>') center/ cover"></div>
    <div class="content">
        <h4 class="name"><?= $row['titre_produit'] ?></h4>
        <?php if ($row['prix_produit'] !== null && $row['prix_produit'] !== 0): ?>
            <h2 class="price"><?= $row['prix_produit'] ?>€</h2>
        <?php else: ?>
