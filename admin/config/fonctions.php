...
function insertProduit($nomProduit, $nomCatSelected, $description, $prix, $cheminImage)
{
    ...
    if ($stmtInsert->execute()) {
        ...
        $message .= '<br><br><a href="../../admin/form/produitsForm.php">Retour au formulaire d\'ajout de produits</a>';
        return $message;
    } else {
...
function updateProduit($id, $nomProduit, $nomCatSelected, $description, $prix, $cheminImage)
{
    ...
    $reqUpdate = 'UPDATE produits SET  titre_produit  = :nomProduit, Id_categorie = :idCategorie, description_produit = :description, prix = :prix, image_produit = :cheminImage WHERE Id_produit = :id';
