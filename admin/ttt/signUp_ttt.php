        ...
        if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($rowCount == 0) {
                ...
                if ($password == $passwordVerif) {
                    ...
                    $inscription = $db->prepare('INSERT INTO users (nom, prenom, telephone, email, pass, inscription_date, token, Id_role) VALUES(:nom, :prenom, :phone, :email, :pass, NOW(), :token, 2)');
                    $inscription->execute(
                        array(
                            ':nom' => $nom,
                            ':prenom' => $prenom,
